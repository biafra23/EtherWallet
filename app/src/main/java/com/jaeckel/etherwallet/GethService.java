...
public class GethService extends Service implements EthereumJsonRpc {
    ...
    private void initGeth() {
        ...
        new Thread(new Runnable() {
            public void run() {
                Timber.d(String.format("absolutePath: %s", getChainDataDir())); //data/data/org.ethereum.droidwallet/files
...
//        Log.d("...done.");
    ...
    private String getChainDataDir() {
        Timber.d(String.format("-> absolutePath: %s", getFilesDir().getAbsolutePath()));
